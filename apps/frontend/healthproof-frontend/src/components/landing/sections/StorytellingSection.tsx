  ...
  return (
    <div className="space-y-8">
      {STORY_CHAPTERS.map((chapter, index) => {
        ...
        return (
          <section
            className="neu-shell relative min-h-screen overflow-hidden border border-white/70 p-5 sm:p-8"
            key={chapter.title}
          >
            ...
            <div className="grid min-h-[calc(100vh-5rem)] items-center gap-7 lg:grid-cols-2">
              ...
              >
                <div className="neu-surface relative overflow-hidden p-4">
                  ...
                  <div className="neu-surface absolute -bottom-6 right-4 w-[42%] p-2 sm:right-6 sm:w-[38%] sm:p-3">
                    <div className="relative aspect-square overflow-hidden rounded-[20px] border border-white/70 bg-(--hp-bg)">
                      <Image
                        alt={`${chapter.title} apoyo visual`}
                        className="object-cover"
                        fill
                        sizes="220px"
                        src={chapter.supportImage}
                      />
                    </div>
                  </div>
                </div>
