...
export interface HealthProofTrustedForwarderInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "eip712Domain"
      | "execute"
...
export interface HealthProofTrustedForwarder extends BaseContract {
  connect(runner?: ContractRunner | null): HealthProofTrustedForwarder;
  waitForDeployment(): Promise<this>;

  interface: HealthProofTrustedForwarderInterface;
